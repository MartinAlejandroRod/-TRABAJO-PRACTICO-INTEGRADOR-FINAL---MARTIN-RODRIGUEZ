...
var preciomasalto = -1000;

botonCaro.addEventListener("click", function () {
  var productosCarrito = document.querySelector(".carro tbody").children;
  ...
  for (let index = 0; index < productosCarrito.length; index++) {
    ...
    var producto1000 = document.querySelector("#producto1000");
    producto1000.innerText = preciomasalto;
  }
});
